...
def main(opt, data_root, det_root=None, seqs=('MOT16-05',), exp_name='demo',
    ...
    print(strsummary)
    Evaluator.save_summary(summary, osp.join(result_root, 'summary_{}.xlsx'.format(exp_name)))
...
if __name__ == '__main__':
    ...
    if not opt.val_mot16:
        seqs_str = '''KITTI-13
                      ...
                      TUD-Stadtmitte'''
        #seqs_str = '''TUD-Campus'''
        data_root = osp.join(opt.data_dir, 'MOT15/images/train')
    else:
        seqs_str = '''MOT16-02
                      MOT16-04
                      MOT16-05
                      ...
                      MOT16-11
                      MOT16-13'''
        data_root = osp.join(opt.data_dir, 'MOT16/train')
    if opt.test_mot16:
        seqs_str = '''MOT16-01
                      MOT16-03
                      MOT16-06
        ...
        data_root = osp.join(opt.data_dir, 'MOT16/test')
    if opt.test_mot15:
        seqs_str = '''ADL-Rundle-1
                      ...
                      TUD-Crossing
                      Venice-1'''
        data_root = osp.join(opt.data_dir, 'MOT15/images/test')
    if opt.test_mot17:
        seqs_str = '''MOT17-01-SDP
                      ...
                      MOT17-12-SDP
                      MOT17-14-SDP'''
        data_root = osp.join(opt.data_dir, 'MOT17/test')
    if opt.val_mot17:
        seqs_str = '''MOT17-02-SDP
                      ...
                      MOT17-11-SDP
                      MOT17-13-SDP'''
        data_root = osp.join(opt.data_dir, 'MOT17/train')
    if opt.val_mot15:
        seqs_str = '''Venice-2
                      KITTI-13
                      KITTI-17
    ...
    if opt.val_mot20:
        seqs_str = '''MOT20-01
                      ...
                      MOT20-05
                      '''
        data_root = osp.join(opt.data_dir, 'MOT20/train')
    if opt.test_mot20:
        seqs_str = '''MOT20-04
                      MOT20-06
                      MOT20-07
                      MOT20-08
                      '''
        data_root = osp.join(opt.data_dir, 'MOT20/images/test')
