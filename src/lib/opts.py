...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--marginal_pr', type=bool, default=False, help='whether use marginal probability as cost')
    ...
    self.parser.add_argument('--pr_thres', type=float, default=0.05, help='confidence thresh for marginal probability')
    ...
    self.parser.add_argument('--data_dir', type=str, default='/home/zyt/FairMOT_m/dataset')
